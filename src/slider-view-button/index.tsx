...
import {IContext, ISliderView} from './types';
import SelfCustomView from './component/self-custom-view';
import {styles} from './styles';

const SlideViewButton: FC<ISliderView> = forwardRef(
  (props: ISliderView, ref: any) => {
    const {
      SelfView,
      startTitle,
      endTitle,
...
SlideViewButton.defaultProps = {
  SelfView: <SelfCustomView />,
  startTitle: 'COMPLETED',
  endTitle: 'SLIDE TO COMPLETE TRIP',
  startStyle: styles.complete,
  endStyle: styles.pending,
  isReset: false,
};

export default SlideViewButton;
